...
COPY Courses(CourseId, CourseName, CourseDescription, DegreeId, ECTS) FROM '/home/student/tables-500/Courses.table' DELIMITER ',' CSV HEADER;
...
COPY CourseRegistrations(CourseOfferId, StudentRegistrationId, Grade) FROM '/home/student/tables-500/CourseRegistrations.table' DELIMITER ',' NULL 'null' CSV HEADER;
